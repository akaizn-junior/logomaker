...
/**
 * The list of colors used here was lifted from the w3schools.com 'w3color.js' Color Converter
 * Found here (https://www.w3schools.com/colors/colors_converter.asp)
 * Downloaded from here (https://www.w3schools.com/lib/w3color.js)
 * as of Tuesday, August 11, 2020.
 * We simply make use of the list of colors to our advantage here
 * the code written is not a direct copy of anything in the original 'w3color.js' file
 */
export default function colorNameToHex(colorName) {
  ...
  // do return a hex value for a color or 'undefined' if color not found
  return hexes[names.indexOf(colorName)];
}
